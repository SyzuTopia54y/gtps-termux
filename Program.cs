...
namespace ItemsDatDecoder
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Stream streamOut = new FileStream(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "data.txt"), FileMode.OpenOrCreate);
            string header1 = "// SYSZ Decoder (C) Syzu, Thanks IProgramInCpp & GrowtopiaNoobs & GuckTubeYT for Helping me\r\n" +
                "// Everything (C) 2013-2023 RTsoft/Hamumu/Ubisoft. All rights reserved.\r\n" +
                "// Formatting: \radd_item\\id\\flagsLow\\flagsHigh\\itemType\\material\\itemName\\fileName\\texHash\\visualEffect\\texX\\texY\\sprType\\isStripey\\collType\\blockHealth\\drops\\clothingType\\rarity\\maxItems\\extraFile\\extraFileHash\\extraFieldNum\\seedBase\\seedOver\\treeBase\\treeOver\\color1BGRA\\color2BGRA\\ingredient1\\ingredient2\\growTime\\petName\\petPrefix\\petSuffix\\petAbility\\extraUnkField1\\extraOptions\\extraFilename\\extraOptions2\\extraUnknown1\\extraUnknown2\\extraUnkShort1\\extraUnkShort2\\extraUnkShort3\\isRayman\\val1\\val2\r\n\r\n";


            byte[] header1Bytes = Encoding.UTF8.GetBytes(header1);
            streamOut.Write(header1Bytes, 0, header1Bytes.Length);

            string header2 = $"version\\{unused}\r\nitemCount\\{itemCount}\r\n\r\n";
